...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "MaVo — Volunteer Together" },
      { name: "description", content: "Join MaVo to clean up your community. Log hours, get supervisor approval, AI-verified cleanups." },
      { property: "og:title", content: "MaVo — Volunteer Together" },
      { name: "twitter:title", content: "MaVo — Volunteer Together" },
